...
Meteor.methods({
  createReport: function (text, tags) {
    ...
    if (Meteor.isServer) {
      Meteor.users.update(this.userId, {
        $addToSet: {'outgoing.reports-created': report}
      });
    }
  ...
  thankReport: function(reportId) {
    ...
    if (Meteor.isServer) {
      ...
      pushThanks.call(this, reportId, submitterId);
    }
  },
